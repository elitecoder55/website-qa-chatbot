...
- **Why**:
  ...
  - FREE API through Groq (30 requests/min)
  - Excellent quality (comparable to GPT-3.5)
  - No OpenAI dependency
  - Fast inference (~1-2 seconds)
- **Fallback**: Smart extraction-based answering when API key not provided
- **Alternatives considered**: 
  - GPT-3.5 (proprietary, costs money)
  - Local Llama (slow, requires GPU)
...
- pip package manager
- (Optional) Groq API key for Llama-powered answers (FREE at https://console.groq.com)
...
### LLM Selection: Llama 3.3 70B via Groq

**Justification:**
1. **FREE**: Groq provides free API access (30 req/min)
2. **Open-source**: Llama by Meta, transparent model
3. **High quality**: 70B parameters, excellent reasoning
4. **Fast**: Groq's infrastructure provides ~1-2 second responses
5. **LangChain integration**: Industry-standard framework
6. **No vendor lock-in**: Can switch to other Llama providers
...
- OpenAI: Costs money, proprietary
- Local Llama: Requires GPU, slow
- Ollama: Requires local setup
- Groq: FREE, fast, hosted
